...
//Чтобы сделать из него поиск по ключу, нужно добавить еще одно поле в AVLNode и методы GetValue(ключ) 
//Ну и добавить изменение значения по одному и тому же ключу при Add
//Также можно сделать несколько значений в AVLNode, добавив туда CountItems, тогда не нужны проверки if Contains
