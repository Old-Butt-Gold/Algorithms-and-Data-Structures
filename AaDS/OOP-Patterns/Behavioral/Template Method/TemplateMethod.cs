namespace AaDS.OOP_Patterns.Behavioral.Template_Method;
...
Разработчики создают их, чтобы позволить клиентам легко и
быстро расширять стандартный код при помощи наследования.
...
//P.S. Чтобы нельзя было скрыть public new void TemplateMethod, лучше наследовать метод от чего-то, и делать 
...
Шаблонный метод работает на уровне классов. 
